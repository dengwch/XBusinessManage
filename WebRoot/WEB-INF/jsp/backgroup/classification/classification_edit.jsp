...
<body>
	<form action="classification/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="CLASSIFICATION_ID" id="CLASSIFICATION_ID" value="${pd.CLASSIFICATION_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">上级分类:</td>
				<td>
<!-- 				<input type="text" name="SUPERIOR" id="SUPERIOR" value="${pd.SUPERIOR}" maxlength="32" placeholder="这里输入上级ID" title="上级ID"/> -->
