...
<body>
	<form action="vipmanger/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="VIPMANGER_ID" id="VIPMANGER_ID" value="${pd.VIPMANGER_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">微信id:</td>
				<td><input type="text" name="WEIXINNO" id="WEIXINNO" value="${pd.WEIXINNO}" maxlength="32" placeholder="这里输入微信id" title="微信id"/></td>
			</tr>
			<tr>
