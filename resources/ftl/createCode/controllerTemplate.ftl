...
public class ${objectName}Controller extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		PageData pageData =this.addLog("新增", "新增${objectName}", "${objectName}");
...
<#list fieldList as var>
	...
	public void delete(PrintWriter out){
		...
		PageData pageData=this.addLog("删除", "删除${objectName}", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView edit() throws Exception{
		...
		try{
		PageData pageData=this.addLog("修改", "修改${objectName}", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView list(Page page){
		...
		try{
		PageData pageData=this.addLog("查看列表", "查看${objectName}列表", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView goAdd(){
		...
		try{
		PageData pageData=this.addLog("去新增", "去新增${objectName}页面", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView goEdit(){
		...
		try{
		PageData pageData=this.addLog("去修改", "去修改${objectName}页面", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
	...
	public Object deleteAll() {
		...
		try{
		PageData pageData=this.addLog("批量删除", "批量删除{objectName}", "${objectName}");
		logService.save(pageData);
		}catch(Exception e){
			logger.error(e.toString(), e);
		}
