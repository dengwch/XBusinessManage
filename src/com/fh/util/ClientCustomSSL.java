...
public class ClientCustomSSL {
    ...
    public final static String toPrint(String xml) throws Exception {
        KeyStore keyStore  = KeyStore.getInstance("PKCS12");
        FileInputStream instream = new FileInputStream(new File("C://apiclient_cert.p12"));
        try {
            keyStore.load(instream, "1441509602".toCharArray());
        } finally {
            instream.close();
        }
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, "1441509602".toCharArray())
                .build();
