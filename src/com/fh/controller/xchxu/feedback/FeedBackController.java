package com.fh.controller.xchxu.feedback;
...
public class FeedBackController extends BaseController {
	...
	public ModelAndView list(Page page,HttpServletRequest request){
		...
		try{
		PageData pageData=this.addLog("查看列表", "查看FeedBack列表", "FeedBack");
		String  BUSINESSUSER_ID=(String) request.getSession().getAttribute("BUSINESSUSER_ID");
		pageData.put("BUSINESSUSER_ID",BUSINESSUSER_ID);
		logService.save(pageData);
		}catch(Exception e){
		...
		try{
			...
			mv.setViewName("backgroup/feedback/feedback_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("backgroup/feedback/feed");
	...
	public ModelAndView goEdit(){
		...
		try {
			...
			mv.setViewName("backgroup/feedback/feedback_edit");
